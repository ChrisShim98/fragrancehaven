...
const FeaturedProduct = () => {
  return (
    <div>
      <div class="min-w-screen min-h-screen bg-light flex items-center p-5 lg:p-10 overflow-hidden relative">
            ...
            <div class="w-full md:w-1/2 px-10 mb-10 md:mb-0">
              <div class="relative">
                <img
                  ...
                  alt=""
                />
                <div class="border-4 border-[#d2b48c] absolute top-10 bottom-10 left-10 right-10 z-0"></div>
              </div>
            </div>
            <div class="w-full md:w-1/2 px-10">
              ...
              <div>
                ...
                <div class="inline-block align-bottom">
                  <button class="bg-dark opacity-100 hover:opacity-75 text-light rounded-full px-10 py-2 font-semibold">
