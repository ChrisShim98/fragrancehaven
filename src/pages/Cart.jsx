  ...
  return (
    <div className="w-full min-h-[50vh] xl:min-h-[80vh] flex flex-col gap-8 items-center">
      ...
      <div className="grid w-full py-4 px-2 md:px-10 pb-10">
        ...
        <div className={cart.length > 0 ? "w-full hidden md:grid place-items-center md:border md:bg-gray-100" : "hidden"}>
        ...
        <div className={cart.length > 0 ? "flex justify-end pt-8 text-xl font-medium px-4" : "hidden"}><h2>Grand Total: ${cartTotalParse(cart)}</h2></div>
      </div>
    </div>
  );
};
